...
if __name__ == "__main__":
    ...
    answer = [ 
        "Це приклад розгорнутої відповіді. Вона може містити кілька рядків.", # Відповідь може займати кілька рядків, кожен рядок - елемент у списку
    ]
    new_question = "Що таке list comprehension у Python та які його переваги?"
    append_student_block("Штельмах К.В.", answer, new_question)
